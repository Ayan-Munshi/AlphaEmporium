...
function Home() {
  return (
    <div id="main body" className="max-w-[1500px] ml-[40px] mr-[40px] grid items-center ">
  <img
  ...
  <div id="productZone1" className="flex flex-wrap mt-[-600px] ml-[100px]  "> {/*flex-wrap for responsiveness*/}
    <Product
      id="1"
      pname="watch"
      ...
      rating={5}
    />
    <Product image="https://images.macrumors.com/t/TkNh1oQ0-9TnnBjDnLyuz6yLkjE=/1600x0/article-new/2023/09/iPhone-15-General-Feature-Black.jpg" id="2" pname="watch" price={73000} rating={5} />
    <Product
      id="1"
      pname="watch"
      image="https://media.istockphoto.com/id/1342734683/photo/an-accessory-for-men.jpg?s=612x612&w=0&k=20&c=KRrVxbNC34_dGQZmB7GmihvTB3OSIz2oKNs5RLrlsBQ="
  ...
  <div id="productZone2" className="flex mt-[-120px] flex-wrap ml-[100px]">
    <Product
      ...
      rating={5}
    />
    <Product image="https://media.istockphoto.com/id/1292038829/photo/laptop-computer-with-blue-pink-lighting-and-blank-screen-place-on-dark-background-3d.jpg?s=612x612&w=0&k=20&c=ZhWHjvdsoFNXQLIrK8oLo6S8auPeSVFs3y5RfJyyhAU=" id="4" pname="watch" price={73000} rating={5} />
